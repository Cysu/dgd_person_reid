#!/usr/bin/env bash
# Fine-tune on a particular dataset with domain guided dropout from JSTL+DGD.
...
MODELS_DIR=models/ft_jstl_dgd
LOGS_DIR=logs/ft_jstl_dgd
SNAPSHOTS_DIR=external/exp/snapshots/ft_jstl_dgd
